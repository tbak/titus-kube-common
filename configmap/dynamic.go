...
type DynamicConfig interface {
	// GetBootstrap returns the configuration state loaded on bootstrap. As bootstrap state never changes, accessing
	// it does not require any synchronization and thus is faster.
	GetBootstrap() interface{}

	// GetRawBootstrap returns the configmap loaded on bootstrap. As bootstrap state never changes, accessing
	//	// it does not require any synchronization and thus is faster.
